    ...
    for (const key in config.themes) {
      if (Object.prototype.hasOwnProperty.call(config.themes, key)) {
        mixedConfig.themes[key].secondary =
          config.themes[key].secondary || defaultConfig.themes?.light.secondary;
        ...
        mixedConfig.themes[key].success =
          config.themes[key].success || defaultConfig.themes?.light.success;
        mixedConfig.themes[key].warning =
          config.themes[key].warning || defaultConfig.themes?.light.warning;
        mixedConfig.themes[key].danger =
          config.themes[key].danger || defaultConfig.themes?.light.danger;
        mixedConfig.themes[key].accent =
          config.themes[key].accent || defaultConfig.themes?.light.accent;
      }
    }
  }
